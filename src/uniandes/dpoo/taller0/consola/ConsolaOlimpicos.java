...
public class ConsolaOlimpicos
{
		...
		while (continuar)
		{
			try
			{
				...
				if (opcion_seleccionada == 1)
					...
					ejecutarBuscarPaisAtleta(nombreAtleta);
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Buscar pair por atleta\n");
	...
	private void ejecutarBuscarPaisAtleta(String nombreAtleta) {
		
		System.out.println("\n" + "Buscar país de un atleta" + "\n");
        
        
        
     String pais = calculadora.buscarPaisAtleta(nombreAtleta);
        
       
     if (pais != null) {
            System.out.println(nombreAtleta + 
     " pertenece al país: " + pais);
        	} else {
                System.out.println("No se encontró el atleta o no tiene un país asociado.");
